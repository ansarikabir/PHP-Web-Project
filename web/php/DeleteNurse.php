...
if (isset($_POST['pname'])){
 $stmt = $conn->prepare("DELETE FROM Nurses WHERE Name=?");
...
<center><form action="DeleteNurse.php" method="post">
<pre> Enter Name of Nurse to be Removed: <input type="text" name="pname">
