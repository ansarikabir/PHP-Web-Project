...
if (isset($_POST['pname']) && isset($_POST['pID']) && isset($_POST['docID'])) {
 $stmt = $conn->prepare("INSERT INTO Doctors(DoctorID, Name, PatientID, NurseID) VALUES (NULL,?,?,?)");
...
<center><form action="InsertDoctor.php" method="post">
<pre> Name: <input type="text" name="pname"> 
Patient ID: <input type="number" name="pID"> 
Nurse ID: <input type="number" name="docID"> 
